...
def evaluation(query_feats, gallery_feats, mask):
    Fars = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1]
    rank = dict()
    pr = dict()
...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--model-prefix', default='/home/master/FedFR-main/ckpt/FedFR', help='path to load model.')
    parser.add_argument('--root-path', default='/home/master/FedFR-main/IJBC', type=str, help='')
    parser.add_argument('--result-dir', default='/home/master/FedFR-main/IJBC/results', type=str, help='')
    ...
    print('use_norm_score : %s, use_detector_score : %s, use_flip_test : %s.' % (
