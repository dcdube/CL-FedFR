...
def load_mx_rec(rec_path):
    save_path = os.path.join(rec_path, 'cl_images')
...
if __name__ == '__main__':
    ...
    # rec_path = '/home/master/FedFR-main'
    # FL loop
    for i in range(40):
        client_id = str(i).zfill(4)  # Convert the loop counter to a zero-padded string
        rec_path = f'/home/master/FedFR-main/ms1m_split/split_train_i4000c0040/client_{client_id}'
        print(rec_path)
