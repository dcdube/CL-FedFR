...
path = "/home/master/FedFR-main/ms1m_split/split_train_i4000c0040/client_0000/train.rec"
image_size = (112,112)
outpath = "/home/master/CR-FIQA/data/quality_data"
...
for idx in tqdm(range(len(bins))):
    ...
    cv2.imwrite(os.path.join(outpath, "images", "%05d.jpg" % idx), img)
