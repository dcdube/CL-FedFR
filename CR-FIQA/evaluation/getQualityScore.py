...
def parse_arguments(argv):
    ...
    parser.add_argument('--data-dir', type=str, default='/home/master/CR-FIQA/data',
                        help='Root dir for evaluation dataset')
    parser.add_argument('--pairs', type=str, default='pairs.txt',
                        help='lfw pairs.')
    parser.add_argument('--datasets', type=str, default='lfw',
                        help='list of evaluation datasets (,)  e.g.  XQLFW, lfw,calfw,agedb_30,cfp_fp,cplfw,IJBC.')
    parser.add_argument('--gpu_id', type=int, default=0,
                        help='GPU id.')
    parser.add_argument('--model_path', type=str, default="/home/master/CR-FIQA/pretrained",
...
def main(param):
    ...
    for dataset in datasets:
        ...
        image_list, absolute_list=read_image_list(os.path.join(param.data_dir,dataset,'image_path_list.txt'), root)
        ...
        quality_score=open(os.path.join(param.data_dir,dataset,param.score_file_name),"a")
