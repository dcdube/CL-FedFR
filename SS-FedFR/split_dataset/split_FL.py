...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir',default='/home/master/FedFR-main/faces_emore/')
    parser.add_argument('--output_dir',default='/home/master/FedFR-main/ms1m_split/')
    ...
    if not os.path.exists(os.path.join(output_dir,'ID2idx.pickle')):
        ...
        save_id_loader = DataLoader(dataset,batch_size=128,collate_fn=collate_fn,shuffle=False,num_workers=5)
