...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--model-prefix', default='/home/master/SS-FedFR/ckpt/FedFR', help='path to load model.')
    parser.add_argument('--root-path', default='/home/master/SS-FedFR/IJBC', type=str, help='')
    parser.add_argument('--result-dir', default='/home/master/SS-FedFR/IJBC/results', type=str, help='')
